Trestle.resource(:transactions) do
  ...
  table do
    ...
    actions do |toolbar, instance, admin|
      if instance.withdraw? && instance.pending?
        toolbar.link 'Approve', admin.path(:approve, id: instance.id), method: :post, class: 'btn btn-primary'
        toolbar.link 'Reject', admin.path(:reject, id: instance.id), method: :post, class: 'btn btn-secondary'
      end
    end
  end
  ...
  controller do
    ...
    def reject
      ...
      return redirect_to transactions_admin_index_path
    end
  end
